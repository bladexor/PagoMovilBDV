...
public class starter extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "b4a.PagoMovilBDV", "b4a.PagoMovilBDV.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.PagoMovilBDV.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
anywheresoftware.b4a.keywords.Common.LogImpl("82555905","SmsSentStatus Success = "+BA.ObjectToString(_success)+", ErrorMessage = "+_errormessage,0);
 //BA.debugLineNum = 97;BA.debugLine="If Success Then";
if (_success) { 
 //BA.debugLineNum = 98;BA.debugLine="Main.TTS.Speak(\"Pago movil Enviado\",False)";
mostCurrent._main._tts /*anywheresoftware.b4a.obejcts.TTS*/ .Speak("Pago movil Enviado",anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 100;BA.debugLine="Main.TTS.Speak(\"Pago movil Fallido\",False)";
mostCurrent._main._tts /*anywheresoftware.b4a.obejcts.TTS*/ .Speak("Pago movil Fallido",anywheresoftware.b4a.keywords.Common.False);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("82424833","TextToSpeechFinish",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("82490369","UserPresent",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("82359298","MessageReceived: From = "+_from+", Body = "+_body,0);
